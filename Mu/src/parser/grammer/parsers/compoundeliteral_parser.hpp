...
#ifndef MU_COMPOUNDELITERAL_PARSER_HPP
#define MU_COMPOUNDELITERAL_PARSER_HPP
...
namespace parse {
    class CompoundedLiteralParser : public PrefixParser {
    public:
...
#endif //MU_COMPOUNDELITERAL_PARSER_HPP
